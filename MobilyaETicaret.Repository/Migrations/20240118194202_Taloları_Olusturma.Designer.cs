...
namespace MobilyaETicaret.Repository.Migrations
{
    ...
    [Migration("20240118194202_Taloları_Olusturma")]
    partial class TalolarıOlusturma
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobilyaETicaret.Core.MobilyaETicaretDatabase.Kategoriler", b =>
                {
                    b.HasOne("MobilyaETicaret.Core.MobilyaETicaretDatabase.Fotograflar", "Fotograflar")
                        .WithOne("Kategoriler")
                        .HasForeignKey("MobilyaETicaret.Core.MobilyaETicaretDatabase.Kategoriler", "FotografId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
